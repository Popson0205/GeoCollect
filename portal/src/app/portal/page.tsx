...
import { ArrowRight, Plus, Map, FileText, Upload, BarChart2 } from "lucide-react";

const ICON_BG: Record<string, string> = {
  layer: "#fff3e0", form: "#e8f5e9", map: "#e3f2fd", dash: "#f3e5f5", view: "#fce4ec",
};
const ICON_EMOJI: Record<string, string> = {
  layer: "🗂️", form: "📋", map: "🗺️", dash: "📊", view: "🗂️",
};

const RECENT = [
  { id:"fl1", name:"Niger Delta Asset Survey",                         type:"layer", sub:"Feature layer (hosted)",        time:"2 days ago" },
  { id:"fl2", name:"Niger Delta Asset Survey_view",                    type:"view",  sub:"Feature layer (hosted, view)",   time:"2 days ago" },
  { id:"f1",  name:"Niger Delta Asset Survey",                         type:"form",  sub:"Survey form",                    time:"2 days ago" },
  { id:"m1",  name:"Niger Delta Power Holding Asset Map",              type:"map",   sub:"Web map",                        time:"2 days ago" },
...
const MAPS = [
  { id:"m1", name:"Niger Delta Power Holding Asset Map", time:"2 days ago" },
...
export default function PortalHome() {
  ...
  const [stats, setStats] = useState({ layers: 2, forms: 2, maps: 2, dashboards: 2 });
    ...
    <div className="gc-page">
      ...
      <div className="gc-hero">
        ...
        <p className="gc-hero-sub">
          Your open-architecture geospatial data collection platform. Collect, manage,<br/>
      ...
      <div className="gc-stats">
        {[
          { label:"Feature Layers", num:stats.layers,     bg:"#fff3e0", emoji:"🗂️", href:"/content?type=layer" },
          { label:"Forms",          num:stats.forms,      bg:"#e8f5e9", emoji:"📋", href:"/forms" },
          { label:"Maps",           num:stats.maps,       bg:"#e3f2fd", emoji:"🗺️", href:"/content?type=map" },
          { label:"Dashboards",     num:stats.dashboards, bg:"#f3e5f5", emoji:"📊", href:"/dashboards" },
      ...
      <div className="gc-home-body">
        ...
        <div>
          {/* Quick Actions */}
          <div className="gc-section-hdr"><span className="gc-section-title">Quick Actions</span></div>
          <div className="gc-qa-card">
            {[
              ...
              { href:"/content/upload", icon:<Upload   size={15} color="#e65100"/>, bg:"#fff3e0", label:"Upload Data",      desc:"Import CSV, GeoJSON, or Shapefile" },
              { href:"/dashboards/new", icon:<BarChart2 size={15} color="#6a1b9a"/>,bg:"#f3e5f5", label:"Build Dashboard",  desc:"Create interactive data dashboards" },
          ...
          {/* Featured Maps */}
          <div className="gc-section-hdr" style={{ marginTop: 16 }}><span className="gc-section-title">Featured Maps</span></div>
